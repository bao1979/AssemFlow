...
| :--- | :--- | :--- | :--- |
| （MVP-1/2/3 未暴露新崩点；后续证据依赖 Q-003 AI 实测 / Q-001 演化 / 第二场景验证补充；MVP-4 撤销机制的边界证据已归档，见 D-015） | — | — | — |
...
| Godot 概念 | 当前判断 | 何时重评 |
| :--- | :--- | :--- |
| StateMachine | MVP-2 门控仅用布尔 `won` + if 分支，未达状态机复杂度 | 未来若引入暂停 / 多存档 / 回放 / 撤销（MVP-4 已归档，需要时重启评估） |
